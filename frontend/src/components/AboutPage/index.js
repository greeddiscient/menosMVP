...
This would not be possible without role models that we respect in our lives. We need someone to guide us on the long and uncertain road to success. <br/><br/>Mentorship has been an ancient common theme in the symbols of our world. From the innate Father - Son relationship, to the classic Master - Apprentice discipleship, to war heroes such as Alexander the Great - Aristotle, and even to popular culture where Luke Skywalker seeks guidance from Obi Wan and Yoda before he goes on to save the universe, mentorship is everywhere. <br/><br/> Menos provides the opportunity of connecting you Indonesians to highly established mentors who will give you the best guidance for your quest. We use mentorship to optimize society as individuals come together and experience how to appreciate, influence, and guide one another creating a chain of positive effects, which in turn will be reciprocated to the rest of the world. <br/><br/>Become the Strongest Version of Yourself!  </p>
      </div>
        ...
        <div className="founders">
          ...
          <div className="founder-window-shaun">
            ...
            <div className= "founder-details">
              ...
              <h4 className= "founder-degree">B.S. EECS</h4>
